...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
            ...
            <!-- Add Alpine Sidebar -->
            <div @click.away="open = false" class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-white md:w-64 dark-mode:text-gray-200 dark-mode:bg-gray-800 border-r-1 " x-data="{ open: false }">
